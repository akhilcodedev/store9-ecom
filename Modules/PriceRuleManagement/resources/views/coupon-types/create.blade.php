                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">Create Coupon Type</h3>
                                    </div>
                                ...
                                <div class="card-body">
                                    <form id="create_coupon_mode_form" method="POST" action="{{ route('priceRule.cart.couponTypes.store') }}">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="{{ route('priceRule.cart.couponTypes.index') }}" class="btn btn-secondary">Cancel</a>
                                        </div>
                                    </form>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href = '{{ route('priceRule.cart.couponTypes.index') }}';  // Redirect back to index
                        } else {
