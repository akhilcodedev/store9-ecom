                    ...
                    <div class="row g-5">
                            ...
                            <div class="card card-flush mb-5 shadow-sm">
                                <div class="card-body text-center pt-9 pb-0 position-relative">
                                    ...
                                    <div class="card card-bordered mt-4">
                                        ...
                                        <div class="card-body p-4">
                                            <ul class="list-unstyled details-list mb-0">
                                                ...
                                                <li class="d-flex justify-content-between align-items-center py-2">
                                                    <span class="text-gray-600"><i class="bi bi-envelope me-1"></i>Email</span>
                                    ...
                                    <div class="mt-5 d-grid">
                                        <a href="{{ route('customers.index') }}" class="btn btn-light-primary btn-hover-scale">
                        ...
                        <div class="col-md-8 col-lg-9">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                <h2 class="fw-bold text-gray-800 me-4 mb-0">Customer Overview</h2>
