...
use Modules\UserPermission\Console\ImportPermissions;
...
class UserPermissionServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'UserPermission';

    protected string $nameLower = 'userpermission';

    protected $commands = [
        ImportPermissions::class,
    ];
    /**
    ...
    public function boot(): void
    {
        ...
        Route::aliasMiddleware('dynamic.roles', DynamicRoles::class);
    }
