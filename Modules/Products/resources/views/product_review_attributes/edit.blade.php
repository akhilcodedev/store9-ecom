        ...
        <div class="card">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    <h1>Edit Product Review Attribute</h1>
                </div>
                <!--begin::Card title-->
            </div>
            <!--end::Card header-->
            ...
            <div class="card-body py-4">
                ...
                <form action="{{ route('product_review_attributes.update', $productReviewAttribute->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" class="form-control form-control-solid" id="name" name="name"
                               value="{{ old('name', $productReviewAttribute->name) }}" placeholder="Attribute Name" required/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" class="form-control form-control-solid" id="label" name="label"
                               value="{{ old('label', $productReviewAttribute->label) }}" placeholder="Display Label" required/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
